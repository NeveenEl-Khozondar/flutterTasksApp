import 'package:ass3/provider.dart';
  ...
  Widget build(BuildContext context) {  
    return Container(
      child: ListView.builder(
        ...
        itemCount: Provider.of<Provider>(context, listen: false).getValue().length,
        itemBuilder: (context, index) {
          Task task = Provider.of<Provider>(context, listen: false).getValue()[index];
